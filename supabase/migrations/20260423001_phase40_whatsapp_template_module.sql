...
CROSS JOIN (
  VALUES
    ('lead_bienvenida_es', 'lead_bienvenida_es', 'marketing', 'Hola {{1}}, gracias por contactar con {{2}}. Te ayudamos a encontrar la propiedad adecuada. ¿Buscas comprar o alquilar y en qué zona te interesa?', 'Nuevo lead inmobiliario', 'Responde a este WhatsApp y seguimos contigo.', 2, '[{"key":"lead_name","label":"Nombre del lead","example":"Marta","required":true},{"key":"agency_name","label":"Nombre de la inmobiliaria","example":"InmoCRM Homes","required":true}]'::jsonb),
    ...
    ('firma_recordatorio_es', 'firma_recordatorio_es', 'utility', 'Hola {{1}}, te recuerdo la firma de {{2}} el {{3}} a las {{4}} en {{5}}. Si necesitas algo antes, dímelo por aquí.', 'Recordatorio de firma', 'Gracias por confirmar asistencia.', 5, '[{"key":"lead_name","label":"Nombre del lead","example":"Sara","required":true},{"key":"process_name","label":"Tipo de firma","example":"contrato de arras","required":true},{"key":"sign_date","label":"Fecha","example":"30/04/2026","required":true},{"key":"sign_time","label":"Hora","example":"12:30","required":true},{"key":"sign_location","label":"Lugar","example":"oficina de InmoCRM Homes","required":true}]'::jsonb)
