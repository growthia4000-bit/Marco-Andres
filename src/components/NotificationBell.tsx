...
export default function NotificationBell() {
  ...
  const formatTime = (dateStr: string) => {
    ...
    if (minutes < 60) return t('notifications.minutesAgo', { value: minutes })
    if (hours < 24) return t('notifications.hoursAgo', { value: hours })
    if (days < 7) return t('notifications.daysAgo', { value: days })
